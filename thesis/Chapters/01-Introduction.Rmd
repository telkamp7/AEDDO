...
Primarily, the focus is on investigating the effectiveness of these methods in detecting disease outbreaks in case studies, particularly in diseases where timely detection allows for feasible interventions. Emphasis is placed on diseases caused by foodborne illnesses, as they are often associated with specific food sources and provide an opportunity for intervention and preventive measures. However, it is important to note that the statistical algorithms discussed in this thesis are not limited to these specific diseases. They can be applied to detect abnormal case counts in any type of disease, enabling early detection and timely response.
