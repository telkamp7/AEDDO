...
The main objective of this research is to assess the effectiveness and practicality of automated outbreak detection methods. To achieve this, a comparative analysis is conducted, evaluating the ability of the novel method to detect outbreaks in the case studies. The performance of the proposed method is benchmarked against the methods currently employed at \gls{SSI} as well as state-of-the-art methods identified in the literature.
