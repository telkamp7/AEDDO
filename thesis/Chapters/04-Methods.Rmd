...
Refer to \@ref(cpp) to access the C++ template for the hierarchical Poisson Gamma model. The objective function maximizes the marginal log-likelihood function, which integrates out the random effects $\boldsymbol u$
