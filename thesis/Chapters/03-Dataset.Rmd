...
In 2014, \gls{WGS} was employed by \gls{SSI} as the routine testing of \textit{Listeria} isolates in Denmark [@Wingstrand_2015]. This method involves mapping the entire DNA of the bacteria and enables \gls{SSI} to identify cases where patients are infected with identical \textit{Listeria} bacteria. However, it is important to note that for this thesis, the DNA typing data is unavailable for use.
