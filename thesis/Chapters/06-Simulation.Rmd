...
In this section, the results regarding the simulation study is presented. Both the state-of-the-art and novel outbreak detection algorithms are applied to the same simulated data. 

As the simulated data comprises weekly counts





The `control` arguments for the Farrington and Noufaily method can be found in Appendix \@ref(controlStateOfTheArt).
