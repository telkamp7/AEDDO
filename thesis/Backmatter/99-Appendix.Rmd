...
In this chapter, all the clusters of \glsfirst{LIST}, \glsfirst{SHIL}, \glsfirst{STEC}, and \glsfirst{SALM} reported to \glsfirst{FUD} is presented. These outbreaks are clusters are summarized in Table \@ref(tab:FUD).
...
SSI_FUD %>%
  ...
  kbl(booktabs = TRUE,
      longtable = TRUE,
      escape = FALSE,
      caption = paste0("Food- and waterborne disease outbreaks of LIST, SHIL, STEC, and SALM reported in \\glsfirst{FUD} (n=",n_SSI_FUD$n,"), 2008-2022."),
      linesep = "") %>%
...
In this chapter, the full overview over the figures and tables related to the case studies is presented.
