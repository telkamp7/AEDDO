...
```{r windowedSTEDPoisN, echo=FALSE, out.width="100%"}
include_graphics("../figures/windowedSTEDPoisN.png")
```
...
```{r windowedSTECPoisG, echo=FALSE, out.width="100%"}
include_graphics("../figures/windowedSTECPoisG.png")
```
