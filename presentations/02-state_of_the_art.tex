...
\FunctionTok{library}\NormalTok{(readr); }\FunctionTok{library}\NormalTok{(dplyr); }\FunctionTok{library}\NormalTok{(tidyr); }\FunctionTok{library}\NormalTok{(surveillance)}
...
\NormalTok{observed }\OtherTok{\textless{}{-}}\NormalTok{ y }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{pivot\_wider}\NormalTok{(}\AttributeTok{names\_from =} \FunctionTok{c}\NormalTok{(ageGroup), }\AttributeTok{names\_sep =} \StringTok{"."}\NormalTok{, }\AttributeTok{values\_from =}\NormalTok{ y) }\SpecialCharTok{\%\textgreater{}\%}
...
\NormalTok{population }\OtherTok{\textless{}{-}}\NormalTok{ y }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{pivot\_wider}\NormalTok{(}\AttributeTok{names\_from =} \FunctionTok{c}\NormalTok{(ageGroup), }\AttributeTok{names\_sep =} \StringTok{"."}\NormalTok{, }\AttributeTok{values\_from =}\NormalTok{ n) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(Date)}
