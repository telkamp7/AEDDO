...
## Organisation of Epimiological Infectious Disease Preparedness

\begin{columns}
\begin{column}{.48\textwidth}
```{r epi_inf_disease_preparedness, echo=FALSE, out.width="90%", fig.pos = "H", fig.show = "hold"}
knitr::include_graphics("../figures/epi_inf_disease_preparedness.png")
```
\end{column}
\begin{column}{.48\textwidth}
\begin{itemize}
...
## About Disease Dynamics & Forecasting @ Epidemiology Research
...
```{r r_packages, echo=FALSE, out.width="75%", fig.pos = "H", fig.show = "hold"}
knitr::include_graphics("../figures/r_packages.png")
```
\end{column}
\end{columns}
